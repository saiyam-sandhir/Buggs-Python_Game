...
class RestartButton(ctk.CTkButton):
    def __init__(self, master):
        restartbutton_img_enter = ctk.CTkImage(light_image=Image.open(".\\images\\restartbutton_img_leave.png"), dark_image=Image.open(".\\images\\restartbutton_img_leave.png"), size=(185, 185))
        restartbutton_img_leave = ctk.CTkImage(light_image=Image.open(".\\images\\restartbutton_img_enter.png"), dark_image=Image.open(".\\images\\restartbutton_img_enter.png"), size=(185, 185))
...
class Frame(baseframe.Frame):
    def __init__(self, master):
        ...
        self.header = ctk.CTkLabel(self, text="Game Over", height=125, width=master.winfo_width() - 2 * self.cget("border_width"), fg_color="transparent", bg_color="transparent", text_color="brown", font=("Freehand521 BT", 100))
